                                ...
                                <tbody>
                                    ...
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <form class="d-inline-block" action="{{url('/admin/projects/categories')}}/{{ $category->id }}" method="POST">
                                                        @csrf
                                                        @method('PUT')
...
<div class="modal fade" id="categoryNewModal" tabindex="-1" role="dialog" aria-labelledby="categoryNewModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-min" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('/').'/admin/projects/categories' }}" method="POST" class="user">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 mb-3">
