...
class GeneralController extends Controller
{
    ...
    public function updateAi(Request $request)
    {
        $data = [
            ...
            'ai_article_reasoning'    => $request->input('ai_article_reasoning'),
            'ai_project_prompt'       => $request->input('ai_project_prompt'),
            'ai_project_reasoning'    => $request->input('ai_project_reasoning'),
        ...
        $validate = Validator::make($data, [
            ...
            'ai_article_reasoning'    => ['nullable', 'string', 'in:none,minimal,low,medium,high,xhigh'],
            'ai_project_prompt'       => ['nullable', 'string'],
            'ai_project_reasoning'    => ['nullable', 'string', 'in:none,minimal,low,medium,high,xhigh'],
        ...
        $data_new = [
            ...
            'ai_article_reasoning'    => $data['ai_article_reasoning'] ?? null,
            'ai_project_prompt'       => $data['ai_project_prompt'] ? trim($data['ai_project_prompt']) : null,
            'ai_project_reasoning'    => $data['ai_project_reasoning'] ?? null,
